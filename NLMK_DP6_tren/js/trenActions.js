...
let tempActions = [
  ...
  [
    ...
    ////--------------------------------18---------------------------------------- 
    {
      ...
      text: 'На ПУ ДП-6 переводим тумблеры клапанов 1, 2, 3 до щелчка в положение «2».',
      sender: 'Система',
      audio: 'tts-29',
    ...
    ////--------------------------------19---------------------------------------- 
    {
      ...
      text: 'На ПУ ДП-6 переводим тумблеры клапанов 1, 2, 3 до щелчка в положение «0».',
      sender: 'Система',
      audio: 'tts-30',
