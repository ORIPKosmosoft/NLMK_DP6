...
let tempActions = [
  ...
  [
    ...
    */
    ...
    // TODO изменить состояние стрелки
    {
      action: {
        window2D: {
          elements: [
    ...
    // Нажал ещё раз на bzu_ZapretSledPorci_btn
    {
      action: {
        window2D: {
          elements: [
      ...
      action: {
        window2D: {
          elements: [
            ...
            // TODO появится стрелка зелёная правая
          ]
        }
      },
    ...
    {
      text: 'На ПУ "Бесконусное загрузочное устройство (БЗУ)" нажать "Приостановить подачу материала".',
      sender: 'Система',
      action: {
