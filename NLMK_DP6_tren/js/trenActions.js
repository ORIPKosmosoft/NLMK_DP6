...
/*                 TODO
---------------------------------------------------------------
Неверные начальные состояния схем ВНК мейн точно
---------------------------------------------------------------
*/
const devHelper = {
  trenVals: {
  ...
  svgHelpers: [
    ...
    },
    {
      name: 'O_n_k_na_VNK_posle_1', helpers: [
        ...
        { x: 53.40, y: 55.4, w: 4.0, h: 2.6, forAction: true, id: 'auto', realName: 'Авто', value: { window: 'O_n_k_na_VNK_posle_2', x: 1124, y: 546, } },
        { x: 57.8, y: 55.4, w: 4.0, h: 2.6, forAction: true, id: 'ruchnoi', realName: 'Ручной', value: { window: 'O_n_k_na_VNK_posle_2', x: 1124, y: 546, } },
        { x: 53.5, y: 59.3, w: 4.0, h: 2.6, forAction: true, id: 'open_vn', realName: 'Открыть', value: { window: 'O_n_k_na_VNK_posle_2', x: 1124, y: 546, } },
        { x: 57.8, y: 59.3, w: 4.0, h: 2.6, forAction: true, id: 'close_ventil', realName: 'Закрыть', value: { window: 'O_n_k_na_VNK_posle_2', x: 1124, y: 546, } },
        ...
        { x: 53.4, y: 72.85, w: 8.5, h: 2.6, forAction: true, id: 'baypas_blokirovok', realName: 'Байпас всех блокировок', value: { window: 'O_n_k_na_VNK_posle_2', x: 1124, y: 546, } },
      ]
    },
    {
    ...
    },
    {
      name: 'dp', helpers: [
        ...
        // ilay
        { x: 75.85, y: 51.5, w: 3.3, h: 3.0, id: 'F_Obsh', name: 'F-Obsh', realName: 'F общ.' },
        { x: 75.85, y: 56.5, w: 3.3, h: 3.0, id: 'F_Tek', name: 'F-Tek', realName: 'F тек.' },
        { x: 29.20, y: 77.7, w: 2.6, h: 2.6, id: 'R_Snort', name: 'R_Snort', }, // TODO realName
        { x: 56.20, y: 68.5, w: 3.3, h: 3.3, id: 'R_Furm', name: 'R_Furm', }, // TODO realName
...
let tempActions = [
  ...
  /*
    ...
    */
    ...
    ////--------------------------------0----------------------------------------//13//-new
    {
      scenarioText: 'Прекращение подачи ПУТ в ДП', // TODO сделать текст этапа
      sender: 'Система',
      startTime: timeDiff + 56.9,
    },
    {
    ...
    ////--------------------------------1----------------------------------------//21//-new
    {
      scenarioText: 'Закрытие кислорода на обогащение дутья и природного газа на печь.', // TODO Сделать новый текст - этап 
      sender: 'Система',
      lifeTime: '08:30:00',
      startTime: timeDiff + 110.5,
    },
    {
    ...
    //1
    {
      action: {
        window2D: {
          elements: [
            { name: '1PS_03_square', color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'text_111', y: 565 },
            { name: 'text_112', y: 565 },
            { name: 'rect_132', position: { y: 81 }, color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'rect_116', position: { y: 123 }, color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: '1PS_05_square', color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'vnk1_red_Arrow', opacity: '0' },
            { name: 'vnk1_red_Arrow_border', opacity: '0' },
            { name: 'vn_116', color: '#ff381b' },
            { name: 'vn_116_l', color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'rect_124', position: { y: 286 }, color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'rect_113', position: { y: 368 }, color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'rect_134', position: { y: 450 }, color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'rect_117', position: { y: 491 }, color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'rect_111', position: { y: 531 }, color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'rect_112', position: { y: 572 }, color: '#ff381b' },
            // End Table
          ]
        }
      },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'kl_132', color: '#ff381b' },
            { name: 'kl_116', color: '#ff381b' },
            { name: 'kl_113', color: '#ff381b' },
            { name: 'kl_124', color: '#ff381b' },
            { name: 'kl_134', color: '#ff381b' },
            { name: 'kl_117', color: '#ff381b' },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'kl_116', color: '#ff381b' },
            { name: '1PS_03', color: '#00FF00' },
            { name: 'kl_121', color: '#ff381b' },
            { name: 'kl_113', color: '#ff381b' },
            { name: 'PS_10', color: '#00FF00' },
            { name: 'kl_124', color: '#ff381b' },
            { name: 'kl_134', color: '#ff381b' },
            { name: '1PS_05', color: '#ff381b' },
            { name: 'kl_140', color: '#00FF00' },
            { name: 'kl_117', color: '#ff381b' },
            { name: 'kl_119', color: '#ff381b' },
            { name: 'kl_111', color: '#ff381b' },
            { name: 'kl_112', color: '#00FF00' },
            { name: 'kl_112', color: '#ff381b' },
            { name: 'kl_136a', color: '#ff381b' },
            { name: 'kl_118a', color: '#ff381b' },
            { name: 'kl_118', color: '#ff381b' },
          ]
        }
      },
      startTime: timeDiff + 147.11,
    },
    // {  // O_p_n_na_k_p_na_VNK close   
    //   action: {
    //     target2D: 'perekidta_exit_btn',
    //   },
    // startTime: timeDiff + 147.2,
    //   human: true,
    // },
    ////--------------------------------3-------------------------------------//24//-new
    {
    ...
    //1
    {
      action: {
        window2D: {
          elements: [
            { name: '2PS_03', color: '#ff381b' },
            { name: '2PS_05', color: '#ff381b' },
    ...
    // Ilay F vnk2 + main
    {
      action: {
        window2D: {
          elements: [
            ...
            { name: 'kl_232', color: '#ff381b' },
            { name: 'kl_227', color: '#00FF00' },
            { name: 'rect_216_2', position: { x: -3 }, color: '#000' },
            { name: 'kl_216', color: '#ff381b' },
            { name: '2PS_03', color: '#ff381b' },
            { name: 'kl_221', color: '#ff381b' },
            { name: 'kl_213', color: '#ff381b' },
            { name: 'PS_10', color: '#00FF00' },
            { name: 'kl_224', color: '#ff381b' },
            { name: 'kl_234', color: '#ff381b' },
            { name: '2PS_05', color: '#ff381b' },
            { name: 'kl_240', color: '#00FF00' },
            { name: 'kl_217', color: '#ff381b' },
            { name: 'kl_219', color: '#ff381b' },
            { name: 'kl_211', color: '#ff381b' },
            { name: 'kl_212', color: '#00FF00' },
            { name: 'kl_212', color: '#ff381b' },
            { name: 'kl_236a', color: '#ff381b' },
            { name: 'kl_218a', color: '#ff381b' },
            { name: 'kl_218', color: '#ff381b' },
            // main
            { name: '7TI_41', text: '39' },
      ...
      startTime: timeDiff + 180.01,
    },
    {  // O_p_n_na_k_na-o_2_na_VNK close
      action: {
        target2D: 'pericNagrev_close_btn',
      },
      startTime: timeDiff + 180.1,
      human: true,
    },
    // {  // O_p_n_na_k_p_na_VNK CLOSE
    //   action: {
    ...
    // ilay bzu
    {
      ...
      startTime: timeDiff + 284.90999999999997,
    },
    {
      action: {
        target3D: 'pKolGaz', //1-1
      ...
      startTime: timeDiff + 284.91999999999996,
    }, {
      action: {
        target3D: 'dpVerh', //2
        color: 'green',
    ...
    { //3D
      ...
      sender: 'Система',
      startTime: timeDiff + 411.1,
    },
    { //3D
      action: {
        target3D: 'Rectangle056',
      },
      startTime: timeDiff + 411.2,
      human: true,
    },
    {
      action: {
    ...
    },
    {
      ...
      action: {
        window2D: {
          elements: [
            { name: 'vn_002', color: '#ff381b' },
            { name: 'circle_kl002', stroke: '#ff381b' },
            { name: 'circle_kl002', stroke: '#ff381b' },
          ]
        }
      },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'P_2', text: '0' },
            { name: 'P_2_rect', color: '#ff381b' },
          ]
        }
      },
      startTime: timeDiff + 634.8,
    },
    {
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: '3PS_03', color: '#ff381b' },
            { name: 'kl_321', color: '#00FF00' },
            { name: 'kl315_proc', text: '22' },
            { name: '3PI_04', text: '0.03' },
            { name: '3PS_05', color: '#ff381b' },
            { name: 'kl323_proc', text: '21' },
            { name: 'kl_311', color: '#ff381b' },
            { name: 'kl_312', color: '#ff381b' },
            { name: '3QI_01', text: '18.71' },
            { name: '3TI_43', text: '76' },
            { name: 'kl_313', color: '#ff381b' },
            { name: '3TI_29', text: '24' },
            { name: 'kl_317', color: '#ff381b' },
            ...
            { name: 'circle_otdeleniye_1', color: '#000' },
            { name: 'circle_otdeleniye_2', color: '#000' },
            { name: 'kl_336a', color: '#ff381b' },
            { name: 'kl_318a', color: '#ff381b' },
            { name: 'kl_318', color: '#00ff00' },
            { name: 'kl_310', color: '#ff381b' },
          ]
        }
      },
      startTime: timeDiff + 653.03,
    },
    {
      action: {
        window2D: {
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'kl_336a', color: '#ff381b' },
            { name: 'kl_318a', color: '#ff381b' },
            { name: 'kl_318', color: '#ff381b' },
            { name: 'kl_310_1', color: '#00FF00' },
            { name: 'kl_310_2', color: '#00FF00' },
          ],
        },
      },
      startTime: timeDiff + 684.11,
    },
    {
      action: {
        target2D: 'vn_319_btn',
    ...
    ////--------------------------------44----------------------------------------//89//-new 
    {
      ...
      sender: 'Система',
      audio: 'radio_say',
      startTime: timeDiff + 696,
    },
    {
      action: {
        target2D: 'close_w1',
      },
      startTime: timeDiff + 696.1,
      human: true,
    },
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'kl_318a', color: '#ff381b' },
            { name: 'kl_318', color: '#ff381b' },
            { name: 'kl_310_1', color: '#ff381b' },
            { name: 'kl_310_2', color: '#ff381b' },
          ],
        },
      },
      startTime: timeDiff + 696.11,
    },
    {
      action: {
        target3D: 'ButtonHightlight_046',
    ...
    },
    {
      ...
      sender: 'Мастер печи',
      audio: 'tts-vo54',
      startTime: timeDiff + 704,
    },
    {
      action: {
        target3D: 'ButtonHightlight_046',
      },
      startTime: timeDiff + 704.1,
      human: true,
    },
    {
      ...
      action: {
        window2D: {
          elements: [
            ...
            { name: 'kl_0333', color: '#ff381b' },
            { name: 'circle_kl0333', stroke: '#ff381b' },
            ...
            { name: 'kl_0332', color: '#ff381b' },
            { name: 'circle_kl0332', stroke: '#ff381b' },
            ...
            { name: 'kl0312_proc', text: '100' },
            { name: 'kl0331_proc', text: '0' },
            { name: 'kl_0331', color: '#ff381b' },
            { name: 'circle_kl0331', stroke: '#ff381b' },
            ...
            { name: 'kl0311_proc', text: '100' },
            { name: '7QI_01', text: '-999,00' },
            { name: 'kl_038', color: '#ff381b' },
            { name: 'circle_kl038', stroke: '#ff381b' },
            { name: 'kl038_proc', text: '0' },
            { name: 'kl028', color: '#ff381b' },
            { name: 'circle_kl028', stroke: '#ff381b' },
            { name: 'kl028_proc', text: '0' },
            // { name: 'kl020_proc',   text: '100' },
            // { name: 'kl036v_proc',  text: '0' },
            // { name: 'kl036b_proc',  text: '0' },
            ...
            { name: 'kl_037', color: '#ff381b' },
            { name: 'circle_kl037', stroke: '#ff381b' },
            { name: 'kl037_proc', text: '0' },
            { name: 'kl007_proc', text: '100' },
            // { name: 'kl025_proc', text: '100' },
