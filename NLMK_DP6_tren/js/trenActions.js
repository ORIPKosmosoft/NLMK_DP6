...
const devHelper = {
  ...
  endVals: {
    ...
    averangeTime: [965, 840, 25 * 60, 24 * 60, 7 * 60],
  ...
  [
    { 
      ...
      multi: [
        ...
        {
          scenarioText: '2. Нажать на кнопку с надписью: «Смена цеха»',
          sender: 'Газовщик',
          action: {
        ...
        {
          scenarioText: '3. Нажать на кнопку с надписью: «Смена цеха»',
          sender: 'Газовщик',
          action: {
        ...
        {
          scenarioText: '4. Нажать на кнопку с надписью: «Смена цеха»',
          sender: 'Газовщик',
          action: {
